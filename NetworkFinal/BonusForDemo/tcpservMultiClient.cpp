...
main(int argc, char **argv) {
	...
	if (a == 1) {
		...
		GameObject * s1 = new SnakeHead(0,'2'); //Actual creation of object.
		objs.push_back(s1);
		GameObject * s2 = new SnakeHead(1,'3'); //Actual creation of object.
		objs.push_back(s2);
		GameObject * f = new Food('1');
		objs.push_back(f);
		cout << "Ready" << endl;
	}
